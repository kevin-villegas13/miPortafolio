...
const Experiencias = [
  {
    date: "02-Feb-2024 - 02-Feb-2025",
    title: " Desarrollador .NET Jr",
    company: "Colombiana de Accesorios",
    description:
      "Desarrollo y soporte de aplicaciones en C#/.NET, utilizando una arquitectura de cuatro capas y diseñando interfaces en Windows Forms. Manejo en la administración de bases de datos MySQL y control de versiones con Git. Habilidades en la creación de documentación técnica y análisis de requerimientos para optimizar los procesos. Participación en proyectos de administración de inventario, facturación y contabilidad, logrando automatizar y mejorar la gestión operativa.",
  },
];
